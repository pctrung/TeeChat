      ...
      >
        <div className="relative w-full flex">
          ...
          <input
            ...
            type="text"
            placeholder="Aa"
            className="bg-gray-200 dark:bg-gray-800 rounded-3xl w-full py-2 px-4 pr-12 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 outline-none transition-all duration-200 relative"
          />
